    ...
    return (
        <div className="ptb-64">
            ...
            <section className="flex flex-wrap jstfy-ctnt-spc-evnly pt-64 gap-4">
                ...
                <section className="img-section grid jstfy-item-center">
                    <img className="quiz-img" src="https://www.dailypioneer.com/uploads/2019/story/images/big/barry-jenkins-pushes--avengers--endgame--for-2020-award-season-2019-04-29.jpg" />
                ...
                <section className="img-section grid jstfy-item-center">
                    <img className="quiz-img" src="https://icebreakerideas.com/wp-content/uploads/2020/09/Space-Trivia-e1608509102528.jpg" alt="space quiz image" />
